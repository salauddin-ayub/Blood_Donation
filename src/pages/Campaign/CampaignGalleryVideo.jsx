...
export default function CampaignGalleryVideo() {
      ...
      <div className="grid grid-cols-4 gap-6 mt-2 mb-2">
        <div className="shadow-2xl bg-white">
          ...
          <p className="bg-red-600  py-2 text-sm rounded-b-md text-center text-white">
            [For Dev]shadow only use when mouse point the specific box sdjfaj
            ajhsfjahsf
          </p>
        </div>
        <div className="shadow-2xl bg-white">
          ...
          <img className="-mt-8" src={ImageNews} alt=""></img>
          <p className="bg-red-600  py-2 text-sm rounded-b-md text-center text-white">
            [For Dev]shadow only use when mouse point the specific box ascf
          </p>
        </div>
        <div className="shadow-2xl bg-white">
          <img
